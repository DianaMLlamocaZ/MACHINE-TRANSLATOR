...
- Nota: Las oraciones del dataset tienen al final el signo de puntuación punto, por lo que se recomienda colocar el punto final en la oración, excepto si es una pregunta.
...
- Posteriormente, copiar solo los archivos con extension .pth y almacenarlos en la carpeta 'models' que se crea luego de clonar el repositorio.
