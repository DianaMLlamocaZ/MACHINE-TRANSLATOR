...
- **Attention:** Implementación de **Bahdanau Attention** desde cero, encargado de generar un vector de contexto que le otorga diferentes pesos a los hidden states generados por el encoder. 
